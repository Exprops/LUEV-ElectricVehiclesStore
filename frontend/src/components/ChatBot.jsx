...
function ChatBot() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {isOpen ? (
        <div className="w-80 bg-white p-4 rounded-xl shadow-xl border border-gray-200 transition-all duration-300">
          {/* Mac-style red close button only */}
          <div className="mac-header mb-3">
            <span
              className="red"
              onClick={() => setIsOpen(false)}
          ...
          <button
            onClick={handleSend}
            className="hover:bg-blue-700 bg-blue-600 text-white text-sm font-medium py-2 rounded-md transition"
          >
            Send
          </button>
        </div>
